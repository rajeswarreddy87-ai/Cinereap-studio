"""
CineRecap Visual Matching Sidecar — v1.4
Semantic frame-to-narration matching using OpenCLIP/CLIP (CPU-only).
Default model: ViT-B-32/openai (fast, good CPU throughput, strong visual match).
SigLIP2 (ViT-SO400M-14-SigLIP2/webli) available as env-override or fallback.
...
VISUAL_MODEL_NAME = os.environ.get("VISUAL_MODEL_NAME", os.environ.get("CLIP_MODEL_NAME", "ViT-B-32"))
VISUAL_MODEL_PRETRAINED = os.environ.get("VISUAL_MODEL_PRETRAINED", os.environ.get("CLIP_PRETRAINED", "openai"))
FALLBACK_MODEL_NAME = os.environ.get("VISUAL_FALLBACK_MODEL_NAME", "ViT-SO400M-14-SigLIP2")
FALLBACK_MODEL_PRETRAINED = os.environ.get("VISUAL_FALLBACK_PRETRAINED", "webli")
